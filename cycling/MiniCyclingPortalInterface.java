...
public interface MiniCyclingPortalInterface extends Serializable {
	...
	/**
	 * the races currently created in the platform.
	 * 
	 ...
	 * @param stageId The ID of the stage the result refers to.
	 * @param riderId The ID of the rider.
	 * @return The adjusted elapsed time for the rider in the stage. Return NULL if there is no result registered for the rider in the stage.
	 * @throws IDNotRecognisedException   If the ID does not match to any rider or
	 *                                    stage in the system.
	 */
